...
@section('title', 'Yeni Hesap Numarası Ekle')

@section('content')
<h1 class="text-3xl font-bold mb-6">Yeni Hesap Numarası Ekle</h1>
...
<form action="{{ route('admin.account-numbers.store') }}" method="POST" class="bg-white p-6 rounded shadow max-w-xl">
    @csrf
    <div class="mb-4">
