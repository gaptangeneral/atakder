...
@section('title', 'Yeni Arama ve Kurtarma Bilgisi Ekle')

@section('content')
<h1 class="text-3xl font-bold mb-6">Yeni Arama ve Kurtarma Bilgisi Ekle</h1>
...
<form action="{{ route('admin.search-rescue.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow max-w-2xl">
    @csrf
    <div class="mb-4">
