...
@section('title', ($about->title ?? 'Hakkımızda') . ' - Atakder')

@section('content')
    <!-- Test Kodu Başlangıcı -->
    <div class="bg-green-100 text-green-800 p-4 mb-6 rounded">
        <strong>Test:</strong> Hakkımızda sayfası render edildi!
    </div>
    <!-- Test Kodu Bitişi -->
    ...
    <section class="relative h-96 flex items-center justify-center">
        <div class="absolute inset-0">
            <img src="{{ $about->hero_image_url ?? 'https://picsum.photos/seed/atakder-about/1920/600.jpg' }}" alt="Hakkımızda" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 text-center text-white px-4">
            ...
            <p class="text-xl max-w-2xl mx-auto">
                @if(!empty($about->subtitle))
                    {{ $about->subtitle }}
                @else
                    Acil Yardım ve Arama Kurtarma Derneği
                @endif
            </p>
        </div>
    </section>
