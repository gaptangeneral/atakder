...
<head>
    ...
    <title>Galeri Resmi Düzenle - <?php echo e(config('app.name', 'Laravel')); ?></title>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <form action="<?php echo e(route('admin.gallery.update', $gallery)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" value="<?php echo e($gallery->title); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                        </div>
                        
                        <div class="mb-4">
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Resim</label>
                            <div class="flex items-center space-x-4">
                                <img src="<?php echo e(asset('storage/' . $gallery->image_path)); ?>" alt="<?php echo e($gallery->title); ?>" class="h-32 w-32 object-cover rounded">
                                <div>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input id="show_on_homepage" name="show_on_homepage" type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" <?php echo e($gallery->show_on_homepage ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="order" name="order" value="<?php echo e($gallery->order); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" min="0">
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\atakder\resources\views/admin/gallery/edit.blade.php ENDPATH**/ ?>