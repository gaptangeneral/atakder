...
<head>
    ...
    <title>Galeri Yönetimi - <?php echo e(config('app.name', 'Laravel')); ?></title>
...
<body class="bg-gray-100">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('admin.gallery.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="gallery-table-body">
                                ...
                                <tr data-id="<?php echo e($gallery->id); ?>">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <img src="<?php echo e(asset('storage/' . $gallery->image_path)); ?>" alt="<?php echo e($gallery->title); ?>" class="h-16 w-16 object-cover rounded">
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($gallery->title); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($gallery->show_on_homepage): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <input type="number" value="<?php echo e($gallery->order); ?>" class="order-input w-16 px-2 py-1 border border-gray-300 rounded text-sm" data-id="<?php echo e($gallery->id); ?>">
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="<?php echo e(route('admin.gallery.edit', $gallery)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Düzenle</a>
                                        <form action="<?php echo e(route('admin.gallery.destroy', $gallery)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        updateOrderBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route('admin.gallery.updateOrder')); ?>', {
                method: 'POST',
                headers: {
...
</html><?php /**PATH C:\xampp\htdocs\atakder\resources\views/admin/gallery/index.blade.php ENDPATH**/ ?>